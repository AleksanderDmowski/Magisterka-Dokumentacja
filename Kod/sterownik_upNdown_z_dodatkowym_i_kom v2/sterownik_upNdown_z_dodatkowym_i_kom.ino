...
//02-09-2025 Funkcja sprawdzająca, czy któryś z dwóch pinów jest wciśnięty (LOW)
...
void setup() { //
  ...
  //02-09-2025 dodanie nowej funkcjonalności z dodatkowymi wejściami dla funkcji isPressed 
